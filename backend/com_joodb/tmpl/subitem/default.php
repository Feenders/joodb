...
<header id="header" class="header mb-3">
    <div class="header-inside py-3">
        <h1 class="page-title"><span class="icon-tree-2"></span>&nbsp;<?php echo HtmlHelper::_('string.truncate', $app->JComponentTitle, 0, false, false); ?></h1>
    </div>
</header>
<div id="wrapper">
            ...
            <table class="paramlist admintable table">
                <tr>
                    <td>
                        <div class="controls controls-row">
                            <label for="label" class="inline"><?php echo Text::_("JDB_NAME"); ?></label>
                            ...
                            <label><?php echo Text::_("JDB_LINKTYPE"); ?></label>
                ...
                <tr>
                    <td>
                        ...
                        <div class="controls controls-row">
                            <label class="inline"><?php echo Text::_("JDB_SUBTABLE"); ?></label>
                            ...
                            <label class="inline"><?php echo Text::_("JDB_TITLEFIELD") ?></label>
                        ...
                        <div id="idx_container" class="elementbox" style="display: none;">
                            <div style="display: block; text-align: center; font-weight: bold; margin-bottom: 5px; "><?php echo Text::_("JDB_INDEX_TABLE"); ?></div>
                            <div style="display: block; text-align: center;">
                                <span><?php echo Text::_("JDB_LEFT_INDEX"); ?></span>
                                ...
                                <span><?php echo Text::_("JDB_RIGHT_INDEX"); ?></span>
                            </div>
                        </div>
                        <div id="idx_container2" class="elementbox" style="display: none;">
                            <label><?php echo Text::_("JDB_TABLE") ?></label>
                ...
                <tr>
                    <td id="config-document">
                        <label><?php echo Text::_("JDB_SUBTEMPLATE_CONTENT"); ?></label>
						<?php
...
<script type="text/javascript">
    ...
    var tdesc = new Array("<?php echo Text::_("JDB_RELATION3")?>","<?php echo Text::_("JDB_RELATION3")?>","<?php echo Text::_("JDB_RELATION3")?>","<?php echo Text::_("JDB_RELATION3");?>");
    ...
    function changeType() {
        ...
        if (document.subForm.type.value==2) {
            jQuery('#islabel').html( "<?php echo Text::_("JDB_PRIMARY_INDEX"); ?>");
            ...
            jQuery('#islabel').html( "<?php echo Text::_("JDB_LEFT_INDEX"); ?>");
            jQuery('#idx_container').css('display','none');

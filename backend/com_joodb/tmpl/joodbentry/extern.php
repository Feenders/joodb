        ...
        <div class="row">
            <div class="col-8">
                <table class="table table-sm">
                    <tr>
                        <td style="width: 40%"> <label for="jform_server"><?php echo Text::_('JDB_Server'); ?></label></td>
                        <td style="width: 80%">
                            <input type="text" value="" class="form-control form-control-sm required" name="server" id="jform_server"/>
                        </td>
                    </tr>
                    <tr>
                        <td><label for="jform_user"><?php echo Text::_('JDB_Username'); ?></label></td>
                        <td>
                            <input type="text" value="" class="form-control form-control-sm required" name="user" id="jform_user"/>
                        </td>
                    </tr>
                    <tr>
                        <td><label for="jform_pass"><?php echo Text::_('JDB_Password'); ?></label></td>
                        <td>
                            <input type="password" value="" class="form-control form-control-sm required" name="pass" id="jform_pass"/>
                        </td>
                    </tr>
                    <tr>
                        <td><label for="datbase"><?php echo Text::_('JDB_Database'); ?></label></td>
                        <td id="dbcontainer">
                            <select class="form-select form-select-sm" id="datbase" name="database"  required>
                                <option value="">...</option>
                            </select>
                        </td>
                    </tr>
            ...
            <div class="col-4 text-center">
                <img src="<?php echo Uri::root(); ?>administrator/components/com_joodb/assets/images/remote.png" alt="*"/>
                <div class="p-3 mb-2">
                    ...
                    <div id="indicator2" style="display: none; margin: 5px 0; padding: 5px; background-color: #d40000; color: #fff; border: 1px solid #ccc; width: 150px; text-align: center;"><?php echo Text::_('Error'); ?></div>
                    <div id="indicator3" style="display: none; margin: 5px 0; padding: 5px; background-color: #3c9103; color: #fff; border: 1px solid #ccc; width: 150px; text-align: center;"><?php echo Text::_('Connection established'); ?></div>
                </div>
                <span class="btn btn-sm btn-primary" onmousedown="testConnection();"><?php echo Text::_('JDB_TEST_CONNECTION'); ?></span>
            </div>
        </div>
    </form>
</div>

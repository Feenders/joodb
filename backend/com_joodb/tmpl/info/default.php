    ...
    <div class="row">
        <div class="col-sm-7">
            <fieldset class="adminform">
                <h3 class="border-bottom mb-2 pb-2"><?php echo Text::_("JDB_HELP");?></h3>
        ...
        <div class="col-sm-5">
            <fieldset class="adminform">
                <h3 class="border-bottom mb-2 pb-2"><?php echo Text::_("JDB_ABOUT");?></h3>
                <table class="adminlist">
                    <tr>
                        <td>
                            <div class="row">
            ...
            <hr/>
            <fieldset class="adminform">
                <h3 class="border-bottom mb-2 pb-2"><?php echo Text::_("JDB_CHANGELIST");?></h3>
                <table class="adminlist">
                    <tr>
                        <td>
            ...
            <fieldset class="adminform">
                <h3 class="border-bottom mb-2 pb-2"><?php echo Text::_( 'Todo' );?></h3>
                <table class="adminlist">
                    <tr>
                        <td>
                            <ul>
            ...
            <fieldset class="adminform">
                <h3 class="border-bottom mb-2 pb-2"><?php echo Text::_( 'License' );?></h3>
                <table class="adminlist">
                    <tr>
                        <td>

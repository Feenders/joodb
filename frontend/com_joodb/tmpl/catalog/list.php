...
<div class="database-list<?php echo $this->params->get('pageclass_sfx')?>">
	<?php if ($this->params->get('show_page_heading') || $this->params->get( 'show_description')) : ?>
		...
		<div class="page-header">
			...
			<?php endif; ?>
	<?php endif; ?>
    <form name="joodbForm" id="joodbForm"  method="post" class="form-inline" action="<?php echo Route::_('index.php'); ?>"  >
        ...
        echo "<p>".HtmlHelper::link('javascript:submitSearch(\'search\');', $text,array('title'=>  Text::_("JDB_BACK"),'class'=>'backbutton'))."</p>";
        ?>

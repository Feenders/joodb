                ...
                <dl>
                    ...
                    <dd>
                        ...
                        <div class="form-check-inline">
                            <input type="checkbox" class="form-check" name="delete_image" id="delete_image" value="1" /><label class="form-check-label" for="delete_image"><?php echo Text::_("JDB_DELETE_IMAGE"); ?></label>
                        </div>
                    </dd>
                </dl>
                <dl>
